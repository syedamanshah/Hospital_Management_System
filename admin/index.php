                        ...
                        <table border="0" class="profile-container">
                            <tr>
                                ...
                                <td style="padding:0px;margin:0px;">
                                    ...
                                    <p class="profile-subtitle">admin@blackapple.com</p>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                ...
                                <td style="width: 25%;">
                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex; ">
                                        <div>
                                                ...
                                                <div class="btn-icon-back dashboard-icons" style="margin-left: 43px;background-image: url('../img/icons/book-hover.svg');"></div>
                                    </div>
                                </td>
                                <td style="width: 25%;">
                        ...
                        <table width="100%" border="0" class="dashbord-tables">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p style="padding-bottom:19px;padding-left:10px;text-align:left;padding-right:48px;font-size:15px;font-weight:500;color:#212529e3;line-height: 20px;">
