...
<body>
    ...
    <div class="full-height">
        ...
        <table border="0">
            <tr>
                <td width="80%">
                    <font class="edoc-logo">Black Apple</font>
            ...
            <tr>
                <td  colspan="3">
                    <p class="sub-text2">How is health today, Sounds like not good!<br>Don't worry. Find your doctor online Book as you wish with Black Apple's HMS <br>
        ...
        <p class="sub-text2 footer-main">Developed and Managed by Black Apple Pvt. Ltd.</p>
    </center>
